...
TASKS = {
 ...
 "Calendars": [
  ...
  T("Grant calendar access",
    ...
    [F("Calendar ID (usually an email address)", "cal"),
     F("Access level", "role", valuemap={"See free/busy only": "freebusy",
       "See all event details": "reader", "Make changes to events": "writer",
       "Make changes + manage sharing": "owner"}),
  ...
  T("Change calendar access level",
    ...
    [F("Calendar ID", "cal"),
     F("New access level", "role", valuemap={"See free/busy only": "freebusy",
       "See all event details": "reader", "Make changes to events": "writer",
       "Make changes + manage sharing": "owner"}),
  ...
  T("Add a calendar to a user's list",
    ...
    [F("User email", "email"), F("Calendar ID to add", "cal"),
     F("Show in their list (selected)?", "selected", False, choices=["", "true", "false"]),
     F("Hidden?", "hidden", False, choices=["", "true", "false"]),
     F("Extra arguments (advanced, optional)", "extra", False, rawappend=True)]),
  T("Show / hide or recolor a calendar in a user's list",
    "Changes how a calendar appears in a user's list: selected (shown) "
    "true/false, hidden true/false, or a color (e.g. Blueberry, Tomato, Sage).",
    "user {email} update calendars {cal} [selected {selected}] [hidden {hidden}] [color {color}]",
    [F("User email", "email"), F("Calendar ID", "cal"),
     F("Selected (shown)?", "selected", False, choices=["", "true", "false"]),
     F("Hidden?", "hidden", False, choices=["", "true", "false"]),
     F("Color name (optional)", "color", False),
     F("Extra arguments (advanced, optional)", "extra", False, rawappend=True)]),
 ...
 "Vault": [
  ...
  T("List matters",
    ...
    [F("State (optional)", "state", False, choices=["", "OPEN", "CLOSED", "DELETED"]),
     F("Send to Google Sheet?", "todrive", False, choices=["", "todrive"]),
     F("Extra arguments (advanced, optional)", "extra", False, rawappend=True)]),
  T("Create hold",
    ...
    [F("Matter (name or ID)", "matter"), F("Hold name", "name"),
     F("Data type", "corpus", choices=["mail", "drive", "groups", "calendar",
       "hangouts_chat", "voice"]),
