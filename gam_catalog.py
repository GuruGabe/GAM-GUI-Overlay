...
TASKS = {
 ...
 "Calendars": [
  ...
  T("Remove calendar access", "Revokes a person's access to the calendar.",
    ...
    [F("Calendar ID (usually an email address)", "cal"), F("User email", "who"),
     F("Extra arguments (advanced, optional)", "extra", False, rawappend=True)],
    destructive=True),
  T("List events",
  ...
  T("Add event",
    ...
    "calendar {cal} add event summary {summary}",
    [F("Calendar ID (usually an email address)", "cal"),
     F("Event title (summary)", "summary"),
     F("Time / attendees (advanced)", "extra", False, rawappend=True)]),
  T("Add a calendar to a user",
    "Subscribes a user to another calendar (adds it to their list).",
    "user {email} add calendars {cal}",
    [F("User email", "email"), F("Calendar ID to add", "cal"),
     F("Extra arguments (advanced, optional)", "extra", False, rawappend=True)]),
  T("List a user's calendars",
